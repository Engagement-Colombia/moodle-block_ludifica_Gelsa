...
$string['contacts_help'] = 'Here you can see your active contacts. To add new ones or manage current ones visit <a href="{$a}" class="btn btn-secondary">the messages page</a>.';
$string['cost'] = 'Cost';
...
$string['deliveredcoins'] = 'Coins delivered';
...
$string['dynamic_help_body_one'] = 'At Gelsa, we seek to connect each employee with the pillars that support our organization. The Route of Knowledge is an experience designed for you to strengthen your relationship with these values. As you complete the assigned courses, you will accumulate coins that will allow you to access avatars and rewards in the virtual store.';
$string['dynamic_help_body_two'] = '';
$string['dynamic_help_body_three'] = '';
$string['edit'] = 'Edit';
...
$string['endcoursedefaulttime'] = 'Default duration if is empty';
$string['endcoursedefaulttime_help'] = 'If the course duration field is empty, this value will be used to calculate the points.';
...
$string['gift'] = 'Gift';
$string['give'] = 'Give';
$string['givecoins'] = 'Give coins';
$string['givecoinsmessage'] = 'The amount of coins to deliver';
...
$string['hideranking'] = 'Hide';
$string['home'] = 'Home';
$string['homeurl'] = 'Home URL';
$string['homeurl_help'] = 'URL to redirect when the user click on the home button. Empty to hide the home button.';
...
$string['insufficientcoins'] = 'Insufficient coins';
$string['invalidbadgecriteriatype'] = "Invalid badge criteria type. Only cohort type is available.";
$string['invalidusercontact'] = 'The user is not a current contact';
...
$string['notcontactsyet'] = 'You don\'t have contacts yet';
...
$string['notgivecoins'] = 'Error delivering coins';
...
$string['ranking_custom_empty'] = 'Top by empty {$a}';
$string['ranking_custom_value'] = 'Top by {$a->type}: <em>{$a->value}</em>';
...
$string['showicon'] = 'Icons only';
$string['shownexttop'] = 'Next top ►';
$string['showranking'] = 'Show ranking';
...
$string['tabcontacts'] = 'Tab Contacts';
$string['tabcontacts_help'] = 'The user contacts information';
...
$string['tabtitle_contacts'] = 'Contacts';
...
$string['userfieldsranking'] = 'Ranking by user fields';
$string['userfieldsranking_help'] = 'List of user fields to show other rankings. Use comma as separator.<br>
Use <em>profile_field_</em> as prefix for custom user fields.<br>
User profile fields availables: institution, department, city, country, lang.';
