...
$string['contacts_help'] = 'Acá puedes ver tus contactos activos. Para agregar nuevos o gestionar los actuales visita <a href="{$a}" class="btn btn-secondary">la página de mensajes</a>.';
$string['cost'] = 'Costo';
...
$string['deliveredcoins'] = 'Monedas entregadas';
...
$string['endcoursedefaulttime'] = 'Duración por defecto del curso';
$string['endcoursedefaulttime_help'] = 'Duración por defecto del curso en días. Se usa cuando no se ha definido una duración en el curso.';
...
$string['eventcriteria_created'] = 'Mejora de criterio creado';
$string['eventcriteria_updated'] = 'Mejora de criterio actualizado';
...
$string['gift'] = 'Regalo';
$string['give'] = 'Regalar';
$string['givecoins'] = 'Regalar monedas';
$string['givecoinsmessage'] = 'La cantidad de monedas a entregar';
...
$string['hideranking'] = 'Ocultar';
$string['home'] = 'Inicio';
$string['homeurl'] = 'URL para Inicio';
$string['homeurl_help'] = 'URL para redireccionar cuando el usuario haga clic en el botón de inicio. Vacío para ocultar el botón de inicio.';
...
$string['improvecriteriasaved'] = 'Criteria de insignia guardado';
$string['improvecriteriaudpate'] = 'Criterio de insignia actualizado';
$string['infodata'] = 'Datos relacionados (formato JSON)';
$string['insufficientcoins'] = 'Monedas insuficientes';
$string['invalidbadgecriteriatype'] = "Tipo de criterio de insignia no válido. Sólo de tipo cohorte están disponibles.";
$string['invalidusercontact'] = 'El usuario no es un contacto válido';
...
$string['notcontactsyet'] = 'Aún no tienes contactos';
...
$string['notgivecoins'] = 'Error al entregar las monedas';
...
$string['notvalidamount'] = 'Cantidad no válida';
...
$string['ranking_custom_empty'] = 'Top para {$a} sin especificar';
$string['ranking_custom_value'] = 'Top para {$a->type}: <em>{$a->value}</em>';
...
$string['shownexttop'] = 'Siguiente top ►';
$string['showranking'] = 'Ver ranking';
...
$string['tabcontacts'] = 'Pesaña Contactos';
$string['tabcontacts_help'] = 'La información de contactos del usuario';
...
$string['tabtitle_contacts'] = 'Contactos';
$string['tabtitle_dynamichelps'] = 'Ayuda';
$string['tabtitle_lastmonth'] = 'Top último mes';
$string['tabtitle_profile'] = 'Perfil';
$string['tabtitle_topbycourse'] = 'Top curso';
$string['tabtitle_topbysite'] = 'Top sitio';
$string['tabtitle_dynamichelps'] = 'Ruta del saber';
$string['tabtopbycourse'] = 'Pestaña Posiciones en el curso';
$string['tabtopbysite'] = 'Pestaña Posiciones en el sitio';
$string['tabview'] = 'Vista de pestaña';
$string['tabview_help'] = 'Elige el diseño de las pestañas cuando hay disponible más de una vista';
...
$string['userfieldsranking'] = 'Posiciones por campos de usuario';
$string['userfieldsranking_help'] = 'Lista de campos de usuario para mostrar otros rankings. Use coma como separador.<br>
Use <em>profile_field_</em> como prefijo para campos de usuario personalizados.<br>
Campos de perfil de usuario disponibles: institution, department, city, country, lang.';
